...
import { controllingHighBlood } from "../../pages/scorecard/pillar-1/d3-measures/controlling-high-blood"
...
Given('User visits the measure page', () => {
    ...
    cy.visit('/state-overviews/scorecard/controlling-high-blood-pressure/index.html');

})

When('User inspects the measure title', () => {

    controllingHighBlood.measureTitle();
...
Then('User sees VISIT THE DOMAIN', () => {
    ...
    controllingHighBlood.visitTheDomain();
...
When('User validates the median rate', () => {
    ...
    controllingHighBlood.medianRate();
...
Then('User sees the West Virginia State Specific Comment', () => {
    ...
    controllingHighBlood.stateSpecificWV();
