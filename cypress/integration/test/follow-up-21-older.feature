Feature: Follow-Up After Hospitalization for Mental Illness: Age 21 & Older
    Description: The purpose of this feature is to test components in the Follow-Up After Hospitalization for Mental Illness: Age 21 & Older
