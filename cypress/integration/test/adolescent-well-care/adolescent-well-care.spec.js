...
Given('User visits the measure page', () => {
    ...
    cy.visit('/state-overviews/scorecard/adolescent-well-care-visits/index.html');
...
Then('User sees the West Virginia State Specific Comment', () => {
    ...
    adolescentWell.stateSpecificWV();
