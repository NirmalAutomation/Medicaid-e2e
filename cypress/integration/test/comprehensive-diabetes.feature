Feature: Comprehensive Diabetes Care: Hemoglobin A1c (HbA1c) Poor Control
    Description: The purpose of this feature is to test components in the Comprehensive Diabetes Care: Hemoglobin A1c (HbA1c) Poor Control (>9.0%) page
