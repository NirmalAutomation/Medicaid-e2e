...
Given('User visits the measure page', () => {
    ...
    cy.visit('/state-overviews/scorecard/comprehensive-diabetes-care/index.html');

})

When('User inspects the measure title', () => {

    comprehensiveDiabetes.measureTitle();
...
Then('User sees VISIT THE DOMAIN', () => {
    ...
    comprehensiveDiabetes.visitTheDomain();
...
Then('User sees the viz title', () => {
    ...
    comprehensiveDiabetes.vizTitle();
...
When('User validates the median rate', () => {
    ...
    comprehensiveDiabetes.medianRate();
...
Then('User sees state rates based on A to Z order', () => {
    ...
    comprehensiveDiabetes.rateList();
...
Then('User sees the West Virginia State Specific Comment', () => {
    ...
    comprehensiveDiabetes.stateSpecificWV();
