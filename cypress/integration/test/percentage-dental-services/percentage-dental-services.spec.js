...
import { percentageDentalServices } from "../../pages/scorecard/pillar-1/d3-measures/percentage-dental-services"
...
Given('User visits the measure page', () => {
    ...
    cy.visit('/state-overviews/scorecard/eligibles-who-received-preventative-dental-services/index.html');

})

When('User inspects the measure title', () => {

    percentageDentalServices.measureTitle();
...
Then('User sees VISIT THE DOMAIN', () => {
    ...
    percentageDentalServices.visitTheDomain();
...
Then('User sees the viz title', () => {
    ...
    percentageDentalServices.vizTitle();
...
When('User validates the median rate', () => {
    ...
    percentageDentalServices.medianRate();
...
Then('User sees state rates based on A to Z order', () => {
    ...
    percentageDentalServices.rateList();
...
Then('User sees the West Virginia State Specific Comment', () => {
    ...
    percentageDentalServices.stateSpecificWV();
