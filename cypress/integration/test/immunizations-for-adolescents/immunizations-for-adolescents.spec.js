...
import { immunizationsAdolescents } from "../../pages/scorecard/pillar-1/d3-measures/immunizations-for-adolescents"
...
Given('User visits the measure page', () => {
    ...
    cy.visit('/state-overviews/scorecard/immunizations-for-adolescents/index.html');

})

When('User inspects the measure title', () => {

    immunizationsAdolescents.measureTitle();
...
Then('User sees VISIT THE DOMAIN', () => {
    ...
    immunizationsAdolescents.visitTheDomain();
...
Then('User sees the viz title', () => {
    ...
    immunizationsAdolescents.vizTitle();
